...
User.create(name: "Alana Jackson", age: "40", location: "Atlanta, Gerogia", username: "LanaJack", email: "Alana@Jackson.com", insurance: "", password: "georgiaPeach")
User.create(name: "Peter Howard", age: "53", location: "Los Angeles, California", username: "BigPete", email: "Peter@Howard.com", insurance: "", password: "GrandpaofFOUR")
User.create(name: "Chad Johnson", age: "29", location: "Raleigh, North Carolina", username: "OchoCinco", email: "Chad@Johnson.com", insurance: "", password: "feb29baby")
User.create(name: "Tiffany Stewart", age: "30", location: "Atlanta, Gerogia", username: "fancyTiff", email: "Tiffany@Stewart.com", insurance: "", password: "ATLshawty")
User.create(name: "Marie Griffin", age: "31", location: "New York, New York", username: "MrsGriffin", email: "Marie@Griffin.com", insurance: "", password: "UptownBaby")
